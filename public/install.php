...
function install($username, $password, $config, $adminUrl)
{
    ...
    $sqlArray = parseSql($sqlPath, $config['prefix'], 'jjjtcrm_');
    Db::startTrans();
    try {
...
return [
    ...
    // 应用映射（自动多应用模式有效）
    'app_map'          => [
        Env::get('jinjieadmin.admin', '{$admin}') => 'admin',
    ],
    // 后台别名
    'admin_alias_name' => Env::get('jinjieadmin.admin', '{$admin}'),
    // 域名绑定（自动多应用模式有效）
    'domain_bind'      => [],
    ...
    // 静态资源上传到OSS前缀
    'oss_static_prefix'   => Env::get('jinjieadmin.oss_static_prefix', 'static_jinjieadmin'),
];
    ...
    <form class="layui-form layui-form-pane" action="">
        ...
        <div class="bg">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input class="layui-input" name="database" autocomplete="off" lay-verify="required" lay-reqtext="请输入数据库名称" placeholder="请输入数据库名称" value="jinjieadmin" disabled="true">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input class="layui-input" disabled="true" name="prefix" autocomplete="off" lay-verify="required" lay-reqtext="请输入数据表前缀" placeholder="请输入数据表前缀" value="jjjtcrm_">
                </div>
            </div>
