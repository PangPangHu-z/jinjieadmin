...
use app\admin\model\InformationInquiry;
 ...
 * @ControllerAnnotation(title="信息询价单管理")
 */
class Inquiry extends AdminController
{
    ...
    public function __construct(App $app)
    {
        ...
        $this->model = new InformationInquiry();
    }
    ...
    {
        $row = $this->model->with(['inquiryProduct','project','contacts'])->find($id)->toArray();
        empty($row) && $this->error('数据不存在');
        $this->assign([
            'id'          => $id,
            'row'         => $row,
